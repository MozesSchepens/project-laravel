...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card mb-4 shadow-sm">
                <img src="<?php echo e(asset('images/sports_bag.png')); ?>" class="card-img-top" alt="Sports bag">
                <div class="card-body">
        ...
        <div class="col-md-3">
            <div class="card mb-4 shadow-sm">
                <img src="<?php echo e(asset('images/third_jersey.png')); ?>" class="card-img-top" alt="Third Jersey">
                <div class="card-body">
