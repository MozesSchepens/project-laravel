...
<div class="container">
    ...
    <div class="player-cards">
        ...
        <div class="player-card">
            <div class="player-card-image">
                <img src="<?php echo e(asset('images/ake.png')); ?>" alt="Nathan Ake">
    ...
    <div class="player-cards">
        <div class="player-card">
            ...
            <div class="player-card-info">
                <img src="<?php echo e(asset('images/nro.png')); ?>" class="flag" alt="Norway">
        ...
        <div class="player-card">
            ...
            <div class="player-card-info">
                <img src="<?php echo e(asset('images/belg.png')); ?>" class="flag" alt="Belgium">
    ...
    <div class="player-cards">
        ...
        <div class="player-card">
            ...
            <div class="player-card-info">
                <img src="<?php echo e(asset('images/arg.png')); ?>" class="flag" alt="Argentina">
    ...
    <a href="<?php echo e(url('admin.players.create')); ?>" class="btn btn-primary mb-3">Add Player</a>
    <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mozes\OneDrive\Bureaublad\bw_mozes_schepens_laravel\resources\views/players/index.blade.php ENDPATH**/ ?>