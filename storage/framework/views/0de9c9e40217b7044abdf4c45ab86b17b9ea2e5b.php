...
<div class="container">
    ...
    <a href="<?php echo e(route('admin.news.create')); ?>" class="btn btn-primary mb-3">Add News</a>
    <?php endif; ?>
    <div class="news-grid">
        ...
        <div class="news-item">
            ...
            <div class="news-info">
                ...
                <?php if(Auth::check() && Auth::user()->is_admin): ?>
                <a href="<?php echo e(route('admin.news.edit', $newsItem->id)); ?>" class="btn btn-warning">Edit</a>
                <form action="<?php echo e(route('admin.news.destroy', $newsItem->id)); ?>" method="POST" style="display:inline;">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mozes\OneDrive\Bureaublad\bw_mozes_schepens_laravel\resources\views/news.blade.php ENDPATH**/ ?>