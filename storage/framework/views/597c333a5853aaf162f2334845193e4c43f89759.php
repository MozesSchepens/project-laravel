    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
                <img src="<?php echo e(asset('images/scarf.png')); ?>" class="card-img-top" alt="Scarf">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
                <img src="<?php echo e(asset('images/sheet.png')); ?>" class="card-img-top" alt="Sheet">
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mozes\OneDrive\Bureaublad\bw_mozes_schepens_laravel\resources\views/shop/accessories.blade.php ENDPATH**/ ?>