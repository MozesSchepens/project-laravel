...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="{{ asset('images/tour1.png') }}" class="img-fluid" alt="Stadium Moment 1">
        </div>
        <div class="col-md-4">
            <img src="{{ asset('images/tour2.png') }}" class="img-fluid" alt="Stadium Moment 2">
        </div>
        <div class="col-md-4">
            <img src="{{ asset('images/tour3.png') }}" class="img-fluid" alt="Stadium Moment 3">
        </div>
    </div>
</div>
@endsection
