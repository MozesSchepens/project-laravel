...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="{{ asset('images/puma.png') }}" class="img-fluid" alt="Partners Moment 1">
        </div>
        <div class="col-md-4">
            <img src="{{ asset('images/Sony-logo.png') }}" class="img-fluid" alt="Partners Moment 2">
        </div>
        <div class="col-md-4">
            <img src="{{ asset('images/Etihad-Airways-Logo.png') }}" class="img-fluid" alt="Partners Moment 3">
        </div>
    </div>
</div>
@endsection
