...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="{{ asset('images/first.png') }}" class="img-fluid" alt="Historic Moment 1">
        </div>
        <div class="col-md-4">
            <img src="{{ asset('images/ageurooo.png') }}" class="img-fluid" alt="Historic Moment 2">
        </div>
        <div class="col-md-4">
            <img src="{{ asset('images/vinnie.png') }}" class="img-fluid" alt="Historic Moment 3">
        </div>
    </div>
</div>
</div>
