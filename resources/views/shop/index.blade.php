...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card mb-4 shadow-sm">
                <img src="{{ asset('images/kits.png') }}" class="card-img-top" alt="Home kit">
                <div class="card-body">
        ...
        <div class="col-md-3">
            <div class="card mb-4 shadow-sm">
                <img src="{{ asset('images/away.png') }}" class="card-img-top" alt="Away kit">
                <div class="card-body">
        ...
        <div class="col-md-3">
            <div class="card mb-4 shadow-sm">
                <img src="{{ asset('images/third.png') }}" class="card-img-top" alt="Third kit">
                <div class="card-body">
