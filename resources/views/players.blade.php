...
<div class="container">
    ...
    <div class="player-cards">
        ...
        <div class="player-card">
            <div class="player-card-image">
                <img src="{{ asset('images/ake.png') }}" alt="Nathan Aké">
        ...
        <div class="player-card">
            <div class="player-card-image">
                <img src="{{ asset('images/sergio.png') }}" alt="Sergio Gomez">
                <div class="player-number">82</div>
            </div>
            <div class="player-card-info">
    ...
    <div class="player-cards">
        <div class="player-card">
            ...
            <div class="player-card-info">
                <img src="{{ asset('images/belg.png') }}" class="flag" alt="België">
        ...
        <div class="player-card">
            ...
            <div class="player-card-info">
                <img src="{{ asset('images/nro.png') }}" class="flag" alt="Noorwegen">
    ...
    <div class="player-cards">
        ...
        <div class="player-card">
            <div class="player-card-image">
             ...
             <div class="player-card-info">
                <img src="{{ asset('images/arg.png') }}" class="flag" alt="Argentinië">
